...
export declare class MDBFileSelectDirective implements OnInit, OnDestroy {
    ...
    ngOnDestroy(): void;
    fileListener: () => void;
    static ɵfac: i0.ɵɵFactoryDeclaration<MDBFileSelectDirective, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<MDBFileSelectDirective, "[mdbFileSelect]", never, { "uploadInput": "uploadInput"; "options": "options"; }, { "uploadOutput": "uploadOutput"; }, never, ["*"]>;
}
