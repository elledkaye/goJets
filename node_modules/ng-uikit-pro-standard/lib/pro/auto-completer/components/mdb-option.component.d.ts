...
export declare class MdbOptionComponent implements OnInit {
    ...
    get label(): any;
    ngOnInit(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<MdbOptionComponent, [null, { optional: true; }]>;
    static ɵcmp: i0.ɵɵComponentDeclaration<MdbOptionComponent, "mdb-option", never, { "value": "value"; "disabled": "disabled"; }, {}, never, ["*"]>;
}
