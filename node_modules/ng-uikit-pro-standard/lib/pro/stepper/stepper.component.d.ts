...
export declare class MdbStepperComponent implements AfterContentInit, AfterViewInit, AfterContentChecked, OnDestroy {
    ...
    private _linear;
    get disableWaves(): boolean;
    set disableWaves(value: BooleanInput);
    private _disableWaves;
    get vertical(): BooleanInput;
    set vertical(v: BooleanInput);
    private _vertical;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<MdbStepperComponent, "mdb-stepper", ["mdbStepper"], { "linear": "linear"; "disableWaves": "disableWaves"; "vertical": "vertical"; }, { "stepChange": "stepChange"; }, ["steps"], never>;
}
