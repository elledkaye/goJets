...
export declare class SBItemBodyComponent implements AfterContentInit, OnDestroy {
    ...
    ngOnDestroy(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<SBItemBodyComponent, [null, null, { optional: true; }]>;
    static ɵcmp: i0.ɵɵComponentDeclaration<SBItemBodyComponent, "mdb-item-body, mdb-accordion-item-body", ["sbItemBody"], { "customClass": "customClass"; }, { "animationStateChange": "animationStateChange"; }, ["routerLinks"], ["*"]>;
}
