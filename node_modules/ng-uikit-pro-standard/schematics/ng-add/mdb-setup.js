...
function addMdbProModuleImport(options) {
    return (tree) => {
        const workspace = (0, config_1.getWorkspace)(tree);
        const project = (0, schematics_2.getProjectFromWorkspace)(workspace, options.project);
        const mdbProModuleName = 'MDBBootstrapModulesPro.forRoot()';
        const mdbProModulePath = 'ng-uikit-pro-standard';
        (0, schematics_2.addModuleImportToRootModule)(tree, mdbProModuleName, mdbProModulePath, project);
        return tree;
    };
}
function addMdbSpinngPreloaderProvider(options) {
    return (tree) => {
        ...
        const providersChanges = (0, ast_utils_1.addProviderToModule)(source, appModulePath, classifiedName, providerPath);
...
function addRobotoFontToIndexHtml() {
    return (tree, context) => {
        ...
        const workspace = (0, config_1.getWorkspace)(tree);
        const project = (0, schematics_2.getProjectFromWorkspace)(workspace);
...
function addAdditionalStylesImports(options) {
    return (tree) => {
        const workspace = (0, config_1.getWorkspace)(tree);
        const project = (0, schematics_2.getProjectFromWorkspace)(workspace, options.project);
        const stylesFile = (0, schematics_2.getProjectStyleFile)(project, 'scss');
        const sectionStyles = `
